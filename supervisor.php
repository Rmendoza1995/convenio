...
.w3ls-banner {
  background: rgb(89,39,45);
background: radial-gradient(circle, rgba(89,39,45,1) 0%, rgba(255,0,18,1) 100%) no-repeat;
...
<a href="soporte.html" type="button" style="width:90%; height:35px; font-size:18px;" class="btn btn-warning">Contactar a Soporte</a>
</center>
...
top: -5px; left: 1440px;"class="btn btn-success">
...
<?php endif; ?>
    ...
    <marquee behavior="alternate" direction="up" width="100%"><marquee direction="right"><img src="logo.png"  width="140px"></marquee></marquee>
    </div>
