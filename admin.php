...
$query  = "SELECT * FROM useros  " ;

?>
<!--inicio tabla-->
<a href="registro.php"   type="button" style="width:320px;" class="btn btn-success">Crear Cliente</a>
<form action="search.php" method="POST">
<div class="md-form mt-0">
<input class="form-control" type="text" placeholder="Buscar usuario " width="30px" name="id" aria-label="Search" required/>
<input type="submit" value="Buscar" class="btn btn-primary">

</div>
</form><a href="logitn.php" type="button" style="width:120px;   float: center;" class="btn  btn-info">Cerrar sesión</a>
...
<a href="upd1.php?id=<?php echo $usuario['id_usuarios'] ?>"   class='btn btn-success'>Editar</a> 
<a href="pdffs.php?id=<?php echo $usuario['id_usuarios'] ?>"    class='btn btn-info'>ver</a> 
<a href="word.php?id=<?php echo $usuario['id_usuarios'] ?>"    class='btn btn-info'>word</a> 
