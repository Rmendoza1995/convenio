...
$mail->Host = 'mail.delti.com.mx';  // Indicamos los servidores SMTP
$mail->SMTPAuth = true;                               // Habilitamos la autenticación SMTP
$mail->Username = 'helpdesk@delti.com.mx';                 // SMTP username
...
$mail->From = 'helpdesk@delti.com.mx';                       // Correo del remitente
$mail->FromName = 'O.S de servicio delti';           // Nombre del remitente
$mail->Subject = 'Hola se ha enviado tú orden de servicio ';                // Asunto

/** Incluir destinatarios. El nombre es opcional **/
$mail->addCC('it@delti.com.mx', 'sistemas');
...
'<div style="color:blue">'.'HelpDesk Delti Soporte.'.'</div><br>'.
'<div >'.'Área de IT Delti
